...
por lo que sus mayores aplicaciones están en la modelación de variables aleatoria que representan proporciones o porcentajes.

Esta función de distribución tiene dos parámetros alpha (a) y beta (b),
los cuales definen la forma de la distribución. El promedio y la varianza se calculan como:
...
"3.- Muestra que el promedio y la desviación estándar del muestreo se aproxima al promedio
y error estándar teóricos de la distribución de la media"
