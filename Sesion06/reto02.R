"El Dataframe 'inseguridad_alimentaria' contiene información de la Encuesta Nacional de Salud
y Nutrición (ENSANUT) 2012, específicamente del módulo de condiciones socieconómicas del hogar
y del módulo de percepción de inseguridad alimentaria en el hogar.
...
logistic.1 <- glm(IA ~ numpeho + edadjef + edadjef:sexojef + añosedu + añosedu:sexojef + alsa + mened, family = binomial)
summary(logistic.1)
